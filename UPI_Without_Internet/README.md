...
Once you see `Started PayLocalApplication in X.XXX seconds`, open:
...
└── src/main/
    ...
    └── java/com/demo/upimesh/
        ├── PayLocalApplication.java          Spring Boot main class
        │
        ├── model/                           ── Domain layer
...
H2 console login: JDBC URL `jdbc:h2:mem:paylocal`, username `sa`, no password.
